...
disclaimer = [
    ...
    "",
    "Miracle-Ear is a trademark of MIRACLE-EAR, INC.",
    "Miracle-Ear Harmony II is created by Miracle-Ear",
    "All rights and credit go to their rightful owners. No copyright infringement intended.",
    "",
    "The contributors of The Checker, and The Checker itself are not affiliated with or endorsed by",
    "Miracle-Ear, Inc. or WS Audiology A/S",
...
fallbackMarket = config.get('MiracleEar', 'Market', fallback='US')

# Read target market from GitHub or local configuration
localMarketPath = Path("MiracleEar.market")
onlineMarketPath = "https://github.com/JediLin/Hearing-Aids-Fitting-Software-Update-Checkers/raw/refs/heads/main/MiracleEar.market"
defaultMarketSrc = ""
try:
...
if (rawXmlData.text == '<s:Envelope xmlns:s="http://www.w3.org/2003/05/soap-envelope" xmlns:a="http://www.w3.org/2005/08/addressing"><s:Header><a:Action s:mustUnderstand="1">http://tempuri.org/IUpdateManagerService/GetPackagesResponse</a:Action><a:RelatesTo>urn:uuid:00000000-0000-0000-0000-000000000000</a:RelatesTo></s:Header><s:Body><GetPackagesResponse xmlns="http://tempuri.org/"><GetPackagesResult xmlns:b="http://schemas.datacontract.org/2004/07/SHS.SAT.UpdateManager.BackEnd.UWS" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"/></GetPackagesResponse></s:Body></s:Envelope>'):
    print("\n" + Fore.RED + "Error" + Style.RESET_ALL + ": The latest available Miracle-Ear Harmony II version for " + Fore.GREEN + targetMarket + Style.RESET_ALL + " market is not found!\n\n")
    exit(1)
...
print("\n\nThe latest available Miracle-Ear Harmony II version for " + Fore.GREEN + targetMarket + Style.RESET_ALL + " market is " + Fore.GREEN + "v" + availableFiles[0][0] + Style.RESET_ALL + "\n\n")
...
downloadVer = 'Miracle-Ear Harmony II ' + targetFile[0]
