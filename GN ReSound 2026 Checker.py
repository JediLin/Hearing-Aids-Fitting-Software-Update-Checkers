...
validVersions = [
    ...
    (" ", "--"),
    ("Archived Versions", "--"),
    ("ReSound Smart Fit v2.4", "smartfit_2.4.270.0_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^C6D@F?5^D>2CE7:E0a]c]af_]_0C6=62D6G6CD:@?]K:A")),
