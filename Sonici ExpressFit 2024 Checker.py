...
fallbackMarket = config.get('Sonic', 'Market', fallback='Default')

# Read target market from GitHub or local configuration
localMarketPath = Path("Sonici.market")
onlineMarketPath = "https://github.com/JediLin/Hearing-Aids-Fitting-Software-Update-Checkers/raw/refs/heads/main/Sonici.market"
defaultMarketSrc = ""
try:
