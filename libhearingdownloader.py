...
def printWaranty():
    warantyDisclaimer = [
        ...
        ""
        "THE SOFTWARE ASSOCIATED WITH THIS SCRIPT (AND THE SCRIPT ITSELF) IS PROVIDED \"AS IS\"",
        ...
        "",
        "THIS UNOFFICIAL SCRIPT IS NOT IN ANY AFFILIATED WITH THE AUTHORS OR COPYRIGHT HOLDERS OF ANY SOFTWARE ASSOCIATED",
        "VIA THE USE OF THIS SCRIPT. THEY HAVE NO REQUIREMENT TO PROVIDE ANY SUPPORT OR WARANTY TO ANY SOFTWARE ASSOCIATED",
        "VIA THE USE OF THIS SCRIPT. THE AUTHORS AND COPYRIGHT HOLDERS OF ANY SOFTWARE ASSOCIATED VIA THE USE OF THIS SCRIPT",
        "RESERVE THE RIGHT TO TERMINATE ANY USAGE OF SOFTWARE ASSOCIATED VIA THIS SCRIPT"
    ]
