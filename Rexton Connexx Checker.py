...
print("\n\n")
print("==================================================")
print("=          " + Style.BRIGHT + Fore.YELLOW + "Rexton" + Style.RESET_ALL + " Connexx Update Checker         =")
...
print("\n\nThe latest available Rexton Connexx version is " + Fore.GREEN + "v" + availableFiles[0][0] + Style.RESET_ALL + "\n\n")
...
downloadVer = 'Rexton Connexx ' + targetFile[0]
