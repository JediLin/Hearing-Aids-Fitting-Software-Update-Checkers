...
validVersions = [
    ...
    (" ", "--"),
    ("Archived Versions", "--"),
    ("Interton Fitting v2.4 Update 1", "fitting_2.4.270.0_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^:?E6CE@?^7:EE:?80a]c]af_]_0C6=62D6G6CD:@?]K:A")),
    ("Interton Fitting v2.3 Update 3", "fitting_2.3.334.51_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^:?E6CE@?^7:EE:?80a]b]bbc]d`0C6=62D6G6CD:@?]K:A")),
    ("Interton Fitting v2.2 Update 2", "fitting_2.2.209.13_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^:?E6CE@?^7:EE:?80a]a]a_h]`b0C6=62D6G6CD:@?]K:A")),
