...
validVersions = [
    ...
    (" ", "--"),
    ("Archived Versions", "--"),
    ("Interton Fitting v2.4", "fitting_2.4.268.0_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^:?E6CE@?^7:EE:?80a]c]aeg]_0C6=62D6G6CD:@?]K:A")),
