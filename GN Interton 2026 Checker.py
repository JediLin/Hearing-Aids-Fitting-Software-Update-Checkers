...
validVersions = [
    ...
    (" ", "--"),
    ("Archived Versions", "--"),
    ("Interton Fitting v2.3 Update 1", "fitting_2.3.334.38_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^:?E6CE@?^7:EE:?80a]b]bbc]bg0C6=62D6G6CD:@?]K:A")),
