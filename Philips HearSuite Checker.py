...
print("==================================================")
print("=        Philips HearSuite Update Checker        =")
...
disclaimer = [
    ...
    "",
    "Bluebotlabz and this checker are not affiliated with or endorsed by Philips",
