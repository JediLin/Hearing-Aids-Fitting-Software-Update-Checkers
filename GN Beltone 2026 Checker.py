...
validVersions = [
    ...
    (" ", "--"),
    ("Archived Versions", "--"),
    ("Beltone Solus Max v2.3", "solusmax_2.3.334.38_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^36=E@?6^D@=FD>2I0a]b]bbc]bg0C6=62D6G6CD:@?]K:A")),
