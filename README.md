...
5. Download latest *3.13.x* (recommended) or *3.8.x* (for Windows 7 compatability) version of `Windows embeddable package` (ZIP archive file) according to your system architecture (64-bit, 32-bit, or ARM64)
