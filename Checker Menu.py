...
downloaders = [
    ...
    (Style.RESET_ALL + "Demant " + Style.BRIGHT + Fore.CYAN + "Sonic" + Style.RESET_ALL + " EXPRESSfit Pro" + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "Sonici ExpressFit 2024.2 Checker.py"),
    ...
    (Style.RESET_ALL + "GN " + Style.BRIGHT + Fore.RED + "ReSound" + Style.RESET_ALL + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "GN ReSound 2026 Checker.py"),
    (Style.RESET_ALL + "GN " + Style.BRIGHT + Fore.BLUE + "Beltone" + Style.RESET_ALL + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "GN Beltone 2026 Checker.py"),
    (Style.RESET_ALL + "GN " + Style.BRIGHT + Fore.YELLOW + "Interton" + Style.RESET_ALL + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "GN Interton 2026 Checker.py"),
    (Style.RESET_ALL + "GN " + Style.BRIGHT + Fore.CYAN + "Danavox" + Style.RESET_ALL + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "GN Danavox 2026 Checker.py"),
    ...
    (Style.RESET_ALL + Fore.GREEN + "Miracle-Ear" + Style.RESET_ALL + " Harmony II" + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "MiracleEar Harmony 2 Checker.py"),
    ...
    (Style.RESET_ALL + Style.BRIGHT + Fore.BLUE + "Starkey" + Style.RESET_ALL + " Pro Fit" + Style.DIM + " / " + Style.RESET_ALL + "Inspire OS" + Style.DIM + " Update Checker" + Style.RESET_ALL, "", "Starkey Pro Fit Checker.py"),
