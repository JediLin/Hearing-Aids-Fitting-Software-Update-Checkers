...
downloaders = [
    (Style.RESET_ALL + Style.DIM + "...Back to Main Menu" + Style.RESET_ALL + "\n   " + Style.DIM + "--------------------------------------------" + Style.RESET_ALL, "", "Checker Menu.py"),
    ...
    (Style.RESET_ALL + Style.DIM + "Open \"The Checker\" (this project) GitHub page\n   with default web browser..." + Style.RESET_ALL, "", "GitHub Page.py"),
]
