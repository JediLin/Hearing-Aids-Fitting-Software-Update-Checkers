...
validVersions = [
    ...
    ("Danavox XE BeMore v2.3 Update 2", "xebemore_2.3.334.43_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^<2^36>@C6^I636>@C60a]b]bbc]cb0C6=62D6G6CD:@?]K:A")),
    ...
    ("Danavox Danalogic v2.3 Update 2", "danalogic_2.3.334.43_releaseversion.zip", rot_codec.rot47_decode("9EEADi^^DFAA@CE8?]8?@?=:?6D6CG:46D]4@>^5@H?=@25D^<2^52?2=@8:4^52?2=@8:40a]b]bbc]cb0C6=62D6G6CD:@?]K:A")),
