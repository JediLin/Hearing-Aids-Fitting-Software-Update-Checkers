...
while updaterRetries > 0:
    try:
        xmlData = requests.get("https://p-svc1.phonakpro.com/1/ObjectLocationService.svc/SoundsInstaller/index?appName=Target%20Sounds&appVer=0.0.0.0;" + hostAppVer + "&dist=Phonak&country=US&subKeys=").text # Request the updater API (spoof older version to get whole installer files rather than "patch" installers)
