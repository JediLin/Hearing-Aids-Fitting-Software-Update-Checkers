...
try:
    ...
    hrefs = [x for x in dom.xpath('//a/@href') if '//' in x and 'oger' in x and 'zip' in x]
    try:
...
validVersions = [
    ...
    (" ", "--"),
    ("Archived Versions", "--"),
    ("Roger Upgrader Software v1.32", "rogerupgrader132.zip", rot_codec.rot47_decode("9EEADi^^HHH]A9@?2<]4@>^4@?E6?E^52>^A9@?2<^6?^5@4F>6?ED^A24<286D^C@86CFA8C256C`ba]K:A]4@C65@H?=@25]K:A")),
