...
print("\n\n")
print("==================================================")
print("=         " + Style.BRIGHT + Fore.RED + "Signia" + Style.RESET_ALL + " Connexx Update Checker          =")
...
disclaimer = [
    ...
    "",
    "Signia is a trademark of WS Audiology A/S",
    "Signia Connexx is created by Signia",
...
fallbackMarket = config.get('Signia', 'Market', fallback='GB')

# Read target market from GitHub or local configuration
localMarketPath = Path("Signia.market")
onlineMarketPath = "https://github.com/JediLin/Hearing-Aids-Fitting-Software-Update-Checkers/raw/refs/heads/main/Signia.market"
defaultMarketSrc = ""
try:
...
print("\n\nThe latest available Signia Connexx version for " + Fore.GREEN + targetMarket + Style.RESET_ALL + " market is " + Fore.GREEN + "v" + availableFiles[0][0] + Style.RESET_ALL + "\n\n")
